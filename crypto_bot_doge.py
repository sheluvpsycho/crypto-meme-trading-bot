...
class CryptoTradingBot:
    def __init__(self, exchange_name: str = "kraken", api_key: str = None, 
        ...
        # Aggressive for DOGE (high volatility)
        self.rsi_period = 14
        self.rsi_oversold = 25  # More aggressive
        self.rsi_overbought = 75  # More aggressive
    ...
    def run_loop(self, interval_seconds: int = 60, max_iterations: Optional[int] = None):
        iteration = 0
        print(f"\n🐕 Starting DOGE trading loop ({self.symbol})...")
    ...
    def print_summary(self):
        ...
        print("\n" + "="*50)
        print("🐕 DOGE BOT - TRADING SUMMARY")
        print("="*50)
